...
## Project Structure
    ...
    ├── ideapros_llc_gratus_32429  # Django project configurations
...
1. Clone this repo and `cd ideapros_llc_gratus_32429`
...
2. Clone this repo and `cd ideapros_llc_gratus_32429`
